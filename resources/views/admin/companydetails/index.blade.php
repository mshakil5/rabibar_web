                ...
                <div class="col-lg-4 offset-lg-1">
                  <form>
                      <div class="form-group">
                          ...
                          {{-- <input class="form-control-file" id="company_logo" value="@if (!empty($company->company_logo)){{$company->company_logo}}@endif" name="company_logo" type="file" aria-describedby="fileHelp"> --}}
                          {{-- logo  --}}
                        ...
                        <div class="form-group">
                          ...
                          {{-- <input class="form-control-file" id="fav_icon" value="@if (!empty($company->fav_icon)){{$company->fav_icon}}@endif" name="fav_icon" type="file" aria-describedby="fileHelp"> --}}
                            {{-- fav logo  --}}
                            <div style="display: flex;">
                                <div>
