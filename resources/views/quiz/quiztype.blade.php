                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="container">
                                    ...
                                    {!! Form::open(['url' => 'admin/quiztype/create','id'=>'createThisForm']) !!}
                            ...
                            <div class="row">
                                <div class="container">
                                    <table class="table table-bordered table-hover" id="example">
                                        ...
                                        @empty
                                            <h3>No post found from you. Create a new Quiz Type</h3>
                                        @endforelse
                                        </tbody>
                                    </table>
                                </div>
