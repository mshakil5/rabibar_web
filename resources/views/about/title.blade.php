                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="container">
                                    ...
                                    {!! Form::open(['url' => 'admin/about/create','id'=>'createThisForm']) !!}
...
{{-- update alart code  --}}
    ...
    <script>
        $(document).ready(function () {
            ...
            var url = "{{URL::to('/admin/about-title')}}";
            // console.log(url);
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#allabout").addClass('active');
            $("#allabout").addClass('is-expanded');
