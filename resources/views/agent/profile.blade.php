        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="user-image">
              <div class="tile user-settings">
                ...
                <form>
                  <div class="row">
                    <input id="agentprofileimageid" value="{{$profile_data->id}}" type="hidden">
...
<script>
  $(document).ready(function(){
      ...
      var passwordurl = "{{URL::to('/agent/changepassword')}}";
            ...
            $(".imgBtn").click(function(){
              var file_data = $('#image').prop('files')[0];
                  ...
                  form_data.append('_method', 'put');
                    ...
                    $.ajax({
                      url:imgurl+'/'+$("#agentprofileimageid").val(),
                      method: "POST",
                      contentType: false,
                      processData: false,
                      data:form_data,
