                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3> User Details</h3>
                            <form  action="{{route('admin.referraluser.search')}}" method ="POST">
                                @csrf
                                <br>
                                <div class="container">
                                    <div class="row">
                                            ...
                                            @if (isset($fromDate) || isset($toDate))
                                                @forelse ($users as $user)
                                                    <tr>
                                                        ...
                                                        <td>{{$user->mobile}}</td>
                                                        <td>
                                                            {{ \App\Models\User::where('referral_id','=', $user->id)->where([
                                                                ['created_at', '>=', $fromDate],
                                                                ['created_at', '<=', $toDate],
                                                            ])->where('status', '=', '1')->count() }}
                                                        </td>
                                                        <td> <a href="{{route('referraluser.view',$user->id)}}" type="button" class="btn btn-info">View</a>
                                                        </td>
                                            ...
                                            @else
                                                ...
                                                @forelse ($users as $user)
                                                    <tr>
                                                        ...
                                                        <td>{{$user->mobile}}</td>
                                                        <td>
                                                            {{ \App\Models\User::where('referral_id','=', $user->id)->where('status', '=', '1')->count() }}
                                                        </td>
                                                        <td> <a href="{{route('referraluser.view',$user->id)}}" type="button" class="btn btn-info">View</a>
                                                        </td>
